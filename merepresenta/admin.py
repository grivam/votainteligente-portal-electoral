...
from merepresenta.models import Candidate, CandidateQuestionCategory, Partido
...
class CandidatePartidoAdmin(admin.ModelAdmin):
    pass

admin.site.register(Partido, CandidatePartidoAdmin)
